...
console.log(buttonShare)
    ...
    for (let item of buttonShare) {
      ...
      item.addEventListener('click', e => {
        ...
        if (typeSocial === 'print') {
          ...
          window.open(
            this.showShareLink(typeSocial), 'sharer', 'top=' + winTop + ',left=' + winLeft + ',toolbar=0,status=0,width=' + winWidth + ',height=' + winHeight);
        }
      });
    }
  };
  ...
  getDescription() {
    let description, content, meta = document.getElementsByTagName('meta');
