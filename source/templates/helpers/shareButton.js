...
/**
 * Initializes render html (buttons)
 * @private
 */
...
/**
 * Initializes click on share buttons
 * @private
 */
shareButton.prototype.eventButton = function () {

    var me = this;
    this.buttonShare = document.getElementsByClassName("share-btn");
    this.winWidth = 520;
    this.winHeight = 320;
    this.winTop = (screen.height / 2) - (this.winHeight / 2);
    this.winLeft = (screen.width / 2) - (this.winWidth / 2);

    for (var i = 0; i < this.buttonShare.length; i++) {
        this.buttonShare[i].addEventListener('click', function() {
            var obj = this;
            this.typeSocial = obj.getAttribute("data-share");

            if(this.typeSocial === 'print') {
                window.print();
            } else {
                window.open(me.showShareLink(this.typeSocial), 'sharer', 'top=' + me.winTop + ',left=' + me.winLeft + ',toolbar=0,status=0,width=' + me.winWidth + ',height=' + me.winHeight);
            }
        }, false);
    }
...
/**
 * Initializes show social link
 * @private
 */
shareButton.prototype.showShareLink = function (typeSocial) {
...
/**
 * Initializes get site url
 * @private
 */
shareButton.prototype.getUrl = function () {
    return window.location.href;
};

/**
 * Initializes get site title
 * @private
 */
shareButton.prototype.getTitle = function () {
    return document.title;
};

/**
 * Initializes get description
 * @private
 */
shareButton.prototype.getDescription = function () {
